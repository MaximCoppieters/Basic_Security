                ...
                <div class="col-sm-8 conversation">
                    ...
                    <div class="row heading">
                        <div class="col-sm-8 col-xs-7 heading-name">
                            <a class="heading-name-meta">Public Chat Room - ${users.size() + 1} chatters</a>
                        </div>
                        <div class="col-sm-1 col-xs-1  heading-dot pull-right">
                            <i class="fa fa-ellipsis-v fa-2x  pull-right" aria-hidden="true"></i>
                        </div>
                    ...
                    <!-- Message Box -->
                    <div class="row message group-messages" id="conversation">
                        <c:forEach items="${messages}" var="message">
                            <div class="row message-body">
                                <div class="col-sm-12 message-main-receiver">
                                    <div class="group-message">
                                        <div class="message-sender" style="color:${message.sender.color}">
                ...
                <form method="post" id="reply-message" enctype="multipart/form-data">
                    ...
                    <div id="reply-row">
                        ...
                        <c:if test="${users.size() > 0}">
                            <select name="correspondent-name" class="form-control receiver-select">
                                <option value="" selected>Ontvanger</option>
                                <c:forEach items="${users}" var="user">
                                    <option>
                                            ${user.username}
                                    </option>
